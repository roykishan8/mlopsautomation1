...
sys.stdin=open('/mlopsautomation1/input.txt','r')
...
accuracy_file = open('/mlopsautomation1/accuracytesting.txt','w')
accuracy_file.write(str(scores[1]))
accuracy_file.close()

display_matter = open('/mlopsautomation1/tracing_accuracy.html','r+')
display_matter.read()
